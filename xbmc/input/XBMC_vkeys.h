...
// Non-printing characters
  ...
  XBMCVK_SLEEP          = 0XDF,
	...
	/* TLBB Remote */
  XBMCVK_TLBB_MUTE		= 0xE0,
  XBMCVK_TLBB_PREV		= 0xE1,
  XBMCVK_TLBB_PLAY      	= 0xE2,
  XBMCVK_TLBB_NEXT      	= 0xE3,
  XBMCVK_TLBB_WIFI      	= 0xE4,
  XBMCVK_TLBB_REW	    	= 0xE5,
  XBMCVK_TLBB_STOP      	= 0xE6,
  XBMCVK_TLBB_FFW       	= 0xE7,
  XBMCVK_TLBB_MENU      	= 0xE8,
  XBMCVK_TLBB_SETTINGS  	= 0xE9,
  XBMCVK_TLBB_HOME      	= 0xEA,
  XBMCVK_TLBB_TEXT      	= 0xEB,
  XBMCVK_TLBB_MUSIC     	= 0xEC,
  XBMCVK_TLBB_MOVIES    	= 0xEE,
  XBMCVK_TLBB_TV        	= 0xEF,
  XBMCVK_TLBB_PICTURES  	= 0xF0,
  XBMCVK_TLBB_INFO      	= 0xF1,
  XBMCVK_TLBB_RED       	= 0xF2,
  XBMCVK_TLBB_GREEN     	= 0xF3,
  XBMCVK_TLBB_YELLOW    	= 0xF4,
  XBMCVK_TLBB_BLUE      	= 0xF5,
