...
typedef enum {
  ...
  XBMCK_FASTFORWARD       = 343,
	...
	/* TLBB Remote */
  XBMCK_TLBB_MUTE      = 0x43,
  XBMCK_TLBB_PREV      = 0x00b4,
  XBMCK_TLBB_PLAY      = 0x0225,
  XBMCK_TLBB_NEXT      = 0x40,
  XBMCK_TLBB_WIFI      = 0x42,
  XBMCK_TLBB_REW	    = 0x3c,
  XBMCK_TLBB_STOP      = 0x41,
  XBMCK_TLBB_FFW       = 0x022e,
  XBMCK_TLBB_MENU      = 0x022d,
  XBMCK_TLBB_SETTINGS  = 0x8d,
  XBMCK_TLBB_HOME      = 0x3d,
  XBMCK_TLBB_TEXT      = 0x3a,
  XBMCK_TLBB_MUSIC     = 0x008a,
  XBMCK_TLBB_MOVIES    = 0x01b6,
  XBMCK_TLBB_TV        = 0x0088,
  XBMCK_TLBB_PICTURES  = 0x003b,
  XBMCK_TLBB_INFO      = 0x0095,
  XBMCK_TLBB_RED       = 0x0096,
  XBMCK_TLBB_GREEN     = 0x0097,
  XBMCK_TLBB_YELLOW    = 0x0098,
  XBMCK_TLBB_BLUE      = 0x009a,
